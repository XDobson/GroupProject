...
function buyTicket() {
    ...
    } else if (document.getElementById("ticketNumAdult").value > 99){   alert("Please enter less than 100 adults.");
    } else if (document.getElementById("ticketNumKid").value > 99){   alert("Please enter less than 100 kids.");
}
}
